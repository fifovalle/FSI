                    ...
                    <div class="col-md-12 col-sm-12 text-start mt-md-2 mb-md-2">
                                ...
                                <ul>
                                    <li>
                                        ...
                                        <p>
                                            ...
                                            <lead class="header-scopus"><a href="<?php echo $kimia['Tautan_Jurnal']; ?>"><?php echo $kimia['Judul_Jurnal']; ?></a></lead><br>
                        ...
                        <?php else : ?>
                            <div class="justify-content-center d-flex">
                                <span class="text-danger fw-bold">Tidak ada data Kimia!</span>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
