            ...
            <div class="modal-body">
                <form method="post" action="../config/add-staff.php">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" placeholder="Masukkan Nama Staff" name="Nama_Staff" class="form-control" id="tambahNamaStaff">
                    </div>
                    <div class="mb-3">
                        <label for="tambahNamaJabatanStaff" class="form-label">Jabatan Staff</label>
                        <input type="text" placeholder="Masukkan Jabatan Staff" name="Jabatan_Staff" class="form-control" id="tambahNamaJabatanStaff">
                    </div>
