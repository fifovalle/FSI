            ...
            <div class="modal-body">
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" name="Gambar" class="form-control" id="suntingGambarBerita" required>
                    </div>
                    <div class="mb-3">
                        <label for="suntingJudulBerita" class="form-label">Judul Berita</label>
                        <input type="text" placeholder="Masukan Judul Berita" name="Judul" class="form-control" id="suntingJudulBerita" required>
                    </div>
                    <div class="mb-3">
