            ...
            <div class="modal-body">
                <form method="post" action="../config/add-dosen.php" enctype="multipart/form-data">
                    <div class="mb-3">
                        ...
                        <input type="number" placeholder="Masukkan NIP / NID" name="NIP_NID_Dosen" class="form-control" id="tambahNIPNID">
                    </div>
                    <div class="mb-3">
                        <label for="tambahNamaDosen" class="form-label">Nama Dosen</label>
                        <input type="text" placeholder="Masukkan Nama Dosen" name="Nama_Dosen" class="form-control" id="tambahNamaDosen">
                    </div>
                    <div class="mb-3">
                        <label for="tambahNamaJabatanDosen" class="form-label">Jabatan Dosen</label>
                        <input type="text" placeholder="Masukkan Jabatan Dosen" name="Jabatan_Dosen" class="form-control" id="tambahNamaJabatanDosen">
                    </div>
