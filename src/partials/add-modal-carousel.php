            ...
            <div class="modal-body">
                <form method="post" action="../config/add-carousel.php" enctype="multipart/form-data">
                    <div class="mb-3">
                        ...
                        <input type="file" class="form-control" name="Gambar" id="tambahGambarCarousel">
                    </div>
                    <div class="mb-3">
                        <label for="tambahJudulCarousel" class="form-label">Judul Carousel</label>
                        <input type="text" placeholder="Masukan Judul Carousel" name="Judul" class="form-control" id="tambahJudulCarousel">
                    </div>
                    <div class="mb-3">
                        <label for="tambahDeskripsiCarousel" class="form-label">Deskripsi Carousel</label>
                        <textarea id="tambahDeskripsiCarousel" class="form-control" placeholder="Masukan Deskripsi Carousel" style="resize: none;" rows="3" name="Deskripsi"></textarea>
                    </div>
