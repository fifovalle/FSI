            ...
            <div class="modal-body">
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" name="Foto_Mahasiswa" class="form-control" id="suntingFotoMahasiswa" required>
                    </div>
                    <div class="mb-3">
                        <label for="suntingNamaMahasiswa" class="form-label">Nama Mahasiswa</label>
                        <input type="text" placeholder="Masukan Nama Mahasiswa" name="Nama_Mahasiswa" class="form-control" id="suntingNamaMahasiswa" required>
                    </div>
                    <div class="mb-3">
