    ...
    <div class="app-brand demo">
        <a href="index.php" class="app-brand-link">
            <span class="app-brand-logo demo">
                <img class="w-px-40 h-auto rounded-circle" src="<?php echo $akar_tautan; ?>src/assets/img/favicon/1.png" alt="Logo">
            </span>
