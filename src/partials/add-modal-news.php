            ...
            <div class="modal-body">
                <form method="post" action="../config/add-news.php" enctype="multipart/form-data">
                    <div class="mb-3">
                        ...
                        <input type="file" name="Gambar" class="form-control" id="tambahGambarBerita">
                    </div>
                    <div class="mb-3">
                        <label for="tambahJudulBerita" class="form-label">Judul Berita</label>
                        <input type="text" placeholder="Masukan Judul Berita" name="Judul" class="form-control" id="tambahJudulBerita">
                    </div>
                    <div class="mb-3">
                        <label for="tambahIsiBerita" class="form-label">Isi Berita</label>
                        <textarea id="tambahIsiBerita" class="form-control" placeholder="Masukan Isi Berita Carousel" style="resize: none;" rows="3" name="Isi_Berita"></textarea>
                    </div>
                    <div class="mb-3">
                        <label for="tambahTanggalTerbitBerita" class="form-label">Tanggal Terbit Berita</label>
                        <input type="date" name="Tanggal_Terbit" class="form-control" id="tambahTanggalTerbitBerita">
                    </div>
