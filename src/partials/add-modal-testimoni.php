            ...
            <div class="modal-body">
                <form method="post" action="../config/add-testimoni.php" enctype="multipart/form-data">
                    <div class="mb-3">
                        ...
                        <input type="file" name="Foto_Mahasiswa" class="form-control" id="tambahFotoMahasiswa">
                    </div>
                    <div class="mb-3">
                        <label for="tambahNamaMahasiswa" class="form-label">Nama Mahasiswa</label>
                        <input type="text" placeholder="Masukan Nama Mahasiswa" name="Nama_Mahasiswa" class="form-control" id="tambahNamaMahasiswa">
                    </div>
                    <div class="mb-3">
                        <label for="tambahKesanMahasiswa" class="form-label">Kesan Mahasiswa</label>
                        <textarea id="tambahKesanMahasiswa" class="form-control" placeholder="Masukan Kesan Mahasiswa" style="resize: none;" rows="3" name="Kesan_Mahasiswa"></textarea>
                    </div>
                    <div class="mb-3">
                        <label for="tambahTsanggalTestimoni" class="form-label">Tanggal Testimoni</label>
                        <input type="date" name="Tanggal_Testimoni" class="form-control" id="tambahTsanggalTestimoni">
                    </div>
