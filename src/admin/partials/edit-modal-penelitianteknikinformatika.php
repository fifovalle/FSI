<div class="modal fade" id="suntingPenelitianTeknikInformatika" tabindex="-1" aria-labelledby="addDataModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addDataModalLabel">Sunting Penelitian Teknik Informatika S1</h5>
            </div>
            <div class="modal-body">
                <form method="post" action="" enctype="multipart/form-data">
                    <input type="hidden" id="suntingIDPenelitianTeknikInformatika" name="ID_Penelitian_If" autocomplete="off">
                    <div class="mb-3">
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-primary" id="tombolSimpanInformatika" name="Simpan"><?php echo htmlspecialchars('Simpan'); ?></button>
                    </div>
                </form>
            </div>
        </div>
