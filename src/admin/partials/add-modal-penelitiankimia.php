    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="../config/add-kimia.php">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" placeholder="Masukkan Link Journal" name="Link_Jurnal" class="form-control" id="tambahLinkJournal" autocomplete="off">
                    </div>
                    <div class="mb-3">
