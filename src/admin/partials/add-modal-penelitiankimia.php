<div class="modal fade" id="tambahPenelitianKimia" tabindex="-1" aria-labelledby="addDataModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addDataModalLabel">Tambah Penelitian Kimia S1</h5>
            </div>
            <div class="modal-body">
                <form method="post" action="" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="link" placeholder="Masukkan Link Journal" name="Link_Journal" class="form-control" id="tambahLinkJournal" autocomplete="off">
                    </div>
                    <div class="mb-3">
                        <label for="tambahCreator" class="form-label">Creator</label>
                        <input type="text" placeholder="Masukkan Creator" name="Creator" class="form-control" id="tambahCreator" autocomplete="off">
                    </div>
                    <div class="mb-3">
