...
try {
    ...
    $mail->addAddress($emailAdmin, $namaDepan);
                                    ...
                                    <tr>
                                        <td style="padding:0 35px; font-family: \'Trebuchet MS\', sans-serif;">
                                            ...
                                            <p style="color:#455056; font-size:15px; line-height:24px; margin:0;">
                                                Anda telah meminta untuk mereset kata sandi akun Anda di Universitas Jenderal Achmad Yani, Fakultas Sains dan Informatika. Silakan klik tautan berikut untuk mereset kata sandi Anda.
                                            </p>
                                            <a href="' . $akar_tautan . 'src/admin/config/reset-pass.php?token=' . $tokenBaru . '" style="background:#20e277; text-decoration:none !important; font-weight:500; margin-top:18px; color:#fff; text-transform:uppercase; font-size:14px; padding:10px 24px; display:inline-block; border-radius:50px;">Atur Ulang Kata Sandi</a>
