...
if ($_SERVER["REQUEST_METHOD"] == "GET" && isset($_GET['id'])) {
    ...
    $hapusData = $kimiaModel->hapusKimia($id);

    $successMessage = htmlspecialchars("Data kimia berhasil dihapus.");
    $failureMessage = htmlspecialchars("Gagal menghapus data kimia.");
