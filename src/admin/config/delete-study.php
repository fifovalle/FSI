...
if ($_SERVER["REQUEST_METHOD"] == "GET" && isset($_GET['id'])) {
    ...
    $hapusData = $programStudiModel->hapusProgramStudi($id);

    $successMessage = htmlspecialchars("Data Program studi berhasil dihapus.");
    $failureMessage = htmlspecialchars("Gagal menghapus data program studi.");
