...
<head>
    ...
    <title>Data Penelitian Sistem Informasi S1</title>
...
<body>
    ...
    <div class="layout-wrapper layout-content-navbar">
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Data /</span> Penelitian Sistem Informasi
                        </h4>
                        <div class="card">
                            <h5 class="card-header">Data Penelitian Sistem Informasi S1</h5>
                            <div style="margin: -10px 40px 10px 0px;">
                                <button type="button" class="btn btn-primary float-end" data-bs-toggle="modal" data-bs-target="#tambahPenelitianSistemInformasi">
                                    Tambah Data
                                </button>
                            </div>
        ...
        <!-- MODAL START -->
        <?php include '../partials/add-modal-penelitiansisteminformasi.php'; ?>
        <?php include '../partials/edit-modal-penelitiansisteminformasi.php'; ?>
        <!-- MODAL END -->
