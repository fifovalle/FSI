...
<body>
    ...
    <div class="layout-wrapper layout-content-navbar">
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Data /</span> Beasiswa Mahasiswa
                        </h4>
                        <div class="card">
                            <h5 class="card-header">Data Beasiswa Mahasiswa</h5>
                            <div style="margin: -10px 40px 10px 0px;">
                                <button type="button" class="btn btn-primary float-end" data-bs-toggle="modal" data-bs-target="#tambahBeasiswaMahasiswa">
                                    Tambah Data
                                </button>
                            </div>
                                ...
                                <table class="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Link Instagram Beasiswa</th>
                                            <th>Link Website Beasiswa</th>
                                            <th>Aksi</th>
                                        </tr>
                                    </thead>
                                    <?php
        ...
        <!-- MODAL START -->
        <?php include '../partials/add-modal-beasiswamahasiswa.php'; ?>
        <?php include '../partials/edit-modal-beasiswamahasiswa.php'; ?>
        <!-- MODAL END -->
