...
<body>
    ...
    <div class="layout-wrapper layout-content-navbar">
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Data /</span> Testimoni
                        </h4>
                        <div class="card">
                            <h5 class="card-header">Data Testimoni</h5>
                            <div style="margin: -10px 40px 10px 0px;">
                                <button type="button" class="btn btn-primary float-end" data-bs-toggle="modal" data-bs-target="#tambahTestimoni">
                                    Tambah Data
                                </button>
                            </div>
                                    ...
                                    <tbody class="table-border-bottom-0">
                                        <?php if (!empty($testimoniInfo)) : ?>
                                            ...
                                            <?php foreach ($testimoniInfo as $testimoni) : ?>
                                                <tr>
                                                    <td>
                                                        <img src="../../uploads/<?php echo $testimoni['Foto_Mahasiswa']; ?>" alt="Avatar" class="rounded-circle avatar avatar-xl" />
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <?php echo $testimoni['Tanggal_Testimoni']; ?>
                                                    </td>
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                <a class="dropdown-item buttonStudy" data-bs-toggle="modal" data-id="<?php echo $testimoni['ID_Testimoni']; ?>"><i class="bx bx-edit-alt me-1"></i>Sunting</a>
        ...
        <!-- MODAL START -->
        <?php include '../partials/add-modal-testimoni.php'; ?>
        <?php include '../partials/edit-modal-testimoni.php'; ?>
        <!-- MODAL END -->
