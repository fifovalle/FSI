<?php include 'src/admin/config/databases.php'; ?>
...
<head>
    ...
    <link rel="stylesheet" href="src/assets/css/index1.css">
</head>
...
<body>
    ...
    <!-- MAIN START -->
    <main class="container-fluid p-0" style="position:relative">
        <?php
            ...
            <div class="carousel-inner animate-down">
                <?php foreach ($carouselInfo as $index => $item) { ?>
                    <div class="carousel-item <?php echo ($index === 0) ? 'active' : ''; ?>">
                        <img src="src/uploads/<?php echo $item['Gambar']; ?>" class="d-block w-100 h-100" alt="...">
                            ...
                            <div class="col-md-3 col-sm-12 text-center">
                                <a href="<?php echo $programStudi['Tautan_Prodi']; ?>" style="text-decoration: none;" target="_blank">
                                    <div class="card card-jurusan mx-auto border border-0" style="width: 18rem;">
                                        <img src="src/uploads/<?php echo $programStudi['Gambar_Prodi']; ?>" class="card-img-top" alt="..." id="icon-jurusan">
                                        <div class="card-body">
                        ...
                        <?php foreach ($agendaInfo as $agenda) : ?>
                            <div class="col-md-3 col-sm-12 my-4">
                                <div class="card card-agenda mx-auto">
                                    <img class="card-img-top" src="src/uploads/<?php echo $agenda['Gambar_Agenda']; ?>" alt="gambar card">
                ...
                <div class="row mt-5 justify-content-center">
                    ...
                    <?php if (!empty($beritaInfo)) : ?>
                        <?php foreach ($beritaInfo as $berita) : ?>
                            <div class="col-md-3 col-sm-12 my-4">
                                <div class="card card-agenda mx-auto">
                                    <img class="card-img-top" src="src/uploads/<?php echo $berita['Gambar']; ?>" alt="gambar card">
                                    <div class="card-body text-center">
                        ...
                        <?php foreach ($pengumumanInfo as $pengumuman) : ?>
                            <div class="col-md-3 col-sm-12 my-4">
                                <div class="card card-pengumuman mx-auto">
                                    <img class="card-img-top" src="src/uploads/<?php echo $pengumuman['Foto_Pengumuman']; ?>" alt="gambar card">
                                    <div class="card-body text-center">
            ...
            <div class="container-fluid p-0">
                <div class="row">
                    <div class="col-md-6 col-sm-12 mb-3 foto-dekan text-center">
                        <img src="src/assets/img/Pimpinan/Dekan.png" class="img-fluid bg-transparent p-0" alt="...">
                    </div>
                ...
                <div class="row fakultas" id="TentangFakultas">
                    ...
                    <div class="col-md-12 col-sm-12 p-0 text-center">
                        <video width="650" height="650" class="video-profil w-100" controls>
                            <source src="src/assets/img/profilvideo/profilvidio.mp4" type="video/mp4">
                        </video>
                    </div>
                </div>
            </div>
                        ...
                        <?php if (!empty($testimoniInfo)) : ?>
                            <?php foreach ($testimoniInfo as $testimoni) : ?>
                                <article class="cCarousel-item">
                                    <img src="src/uploads/<?php echo $testimoni['Foto_Mahasiswa']; ?>" alt="Foto Mahasiswa">
                                    <div class="infos">
    ...
    <script src="src/assets/js/navbar1.js"></script>
    <!-- MAIN END -->
